...
class MicrojobController extends Controller
{
	...
	public function actionAjaxCreate()
	{
		...
		if(isset($_POST['Microjob']))
		{
			...
			$_POST['Microjob']['timestamp'] = date( 'Y-m-d H:i:s');
			$model->attributes=$_POST['Microjob'];
...
//				$this->redirect(array('view','id'=>$model->id));
	...
	{
		$model=new Microjob('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Microjob']))
			$model->attributes=$_GET['Microjob'];
	...
	{
		$model=Microjob::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='microjob-form')
		{
